...
# parameters
num_of_perturb = 20  # number of generated similar words for a given position
...
def generate(sent):
    # because the running directory is under codebook/
    # print(os.path.abspath(os.curdir))
    with open("./baselines/synonyms.dat", 'rb') as f:
        synonyms = pickle.load(f)

    # generate far more sentences
    syntactically_similar_sentences = perturb(sent, bertmodel, num_of_perturb)
